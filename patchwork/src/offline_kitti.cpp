...
int main(int argc, char**argv) {
    ...
    CloudPublisher     = nh.advertise<sensor_msgs::PointCloud2>("/benchmark/cloud", 1, true);
    TPPublisher        = nh.advertise<sensor_msgs::PointCloud2>("/benchmark/TP", 1, true);
    FPPublisher        = nh.advertise<sensor_msgs::PointCloud2>("/benchmark/FP", 1, true);
    FNPublisher        = nh.advertise<sensor_msgs::PointCloud2>("/benchmark/FN", 1, true);
